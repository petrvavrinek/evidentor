...
interface TaskTableRowProps {
  task: ProjectTask;
  onTaskUpdateShow?: (task: ProjectTask) => void;
}

export default function TaskTableRow({ task, onTaskUpdateShow }: TaskTableRowProps) {
  return (
    <>
      <TableRow>
        ...
        <TableCell className="w-[80px]">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => onTaskUpdateShow?.(task)}>Edit</DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem
