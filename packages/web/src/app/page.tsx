          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Evidentor combines powerful tools to streamline your workflow
                  and boost productivity - all at no cost.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 md:grid-cols-3 md:gap-12">
              ...
              <div className="grid gap-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Gain valuable insights with detailed reports on productivity,
              ...
              <div className="grid gap-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Share projects and collaborate with team members. Perfect for
                  agencies and teams. (Coming Soon)
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="rounded-xl border bg-card p-6 shadow-sm">
                ...
                <p className="mt-2 text-muted-foreground">
                  Create professional invoices in seconds and send them directly
                  to clients with payment options.
                </p>
              </div>
              <div className="rounded-xl border bg-card p-6 shadow-sm">
                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10 text-primary">
                ...
                <p className="mt-2 text-muted-foreground">
                  Track your time and identify areas for improvement to maximize
                  your efficiency.
                </p>
              </div>
              <div className="rounded-xl border bg-card p-6 shadow-sm">
              ...
              <div className="rounded-xl border bg-card p-6 shadow-sm">
                ...
                <h3 className="mt-4 text-xl font-bold">Centralize Your Work</h3>
                <p className="mt-2 text-muted-foreground">
